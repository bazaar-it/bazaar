...
jest.mock('openai', () => {
  ...
  mockCreate.mockResolvedValue({
    ...
    // Add usage field as it's often expected in ChatCompletion type
    usage: {
      prompt_tokens: 10,
      completion_tokens: 20,
      total_tokens: 30,
    }
  } as OpenAI.Chat.ChatCompletion); // Added 'as OpenAI.Chat.ChatCompletion' for good measure
