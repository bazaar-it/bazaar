...
export default function AdminDashboard() {
  ...
  // Conditional tRPC queries - only run if authenticated and admin
  const { data: dashboardData, isLoading, error } = api.admin.getDashboardMetrics.useQuery(
    undefined,
    {
      enabled: isAuthenticated && isAdmin, // Only fetch if user is authenticated admin
      retry: 3,
      retryDelay: 1000,
    }
  );
