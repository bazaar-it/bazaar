...
import { users, projects, scenes, feedback, messages, accounts, imageAnalysis, sceneIterations, projectMemory } from "@bazaar/database";
...
export default function GeneratedScene() {
  ...
  getUserAnalytics: adminOnlyProcedure
    ...
    .query(async ({ input, ctx }) => {
      console.log('🔍 getUserAnalytics called with:', { input, hasCtx: !!ctx });
      const { 
        limit, 
        offset, 
        sortBy, 
