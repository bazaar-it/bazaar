...
const AdminVideoPlayer = dynamic(() => import("~/components/admin/AdminVideoPlayer"), {
  ssr: false,
  loading: () => (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <div className="space-y-4 max-h-96 overflow-y-auto">
            {projectDetails.scenes.map((scene) => (
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <div className="space-y-4 max-h-96 overflow-y-auto">
            {projectDetails.chatHistory.map((message) => (
      ...
      {projectDetails.sceneIterations.length > 0 && (
        <div className="bg-white shadow rounded-lg p-6 mt-6">
          ...
          <div className="space-y-4">
            {projectDetails.sceneIterations.map((iteration, index) => (
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <div className="font-medium text-gray-900">
                        {projectDetails.scenes.find(s => s.id === iteration.sceneId)?.name || 'Unknown Scene'}
                      </div>
      ...
      {projectDetails.projectMemory.length > 0 && (
        <div className="bg-white shadow rounded-lg p-6 mt-6">
          ...
          <div className="space-y-3">
            {projectDetails.projectMemory.map((memory) => (
