/**
 * Preview Font Loader
 * Loads ANY Google Font in the browser preview (not for Lambda)
 * This allows the AI to use any font name and we show it correctly in preview
 */

// Extract font families from code (local implementation to avoid circular imports)
