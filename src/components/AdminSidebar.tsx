...
export default function AdminSidebar({ activeSection, onSectionChange }: AdminSidebarProps) {
  ...
  const currentSection = pathname === '/admin' ? (activeSection || 'homepage') :
    ...
    pathname === '/admin/feedback' ? 'feedback' :
      ...
      <div className="p-6">
        ...
        <nav className="mt-10">
          <div className="space-y-1">
            ...
            >
              <svg className="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8h2a2 2 0 012 2v7a2 2 0 01-2 2h-3l-4 4v-4H7a2 2 0 01-2-2v-1" />
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 3h-6a2 2 0 00-2 2v7a2 2 0 002 2h6l4 4V5a2 2 0 00-2-2z" />
              </svg>
              Feedback
            </Link>
