      ...
      const result = {
        ...
        result: {
          ...
          toolContext: {
            ...
            requestedDurationSeconds: toolSelection.requestedDurationSeconds, // Duration in seconds
            requestedScenes: toolSelection.requestedScenes, // Requested scene count
